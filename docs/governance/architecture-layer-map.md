...
| ----------------------- | --------------------------------------------------------- | -------------------------------------------------------------------------------------- | ----------- | -------- | ----------------------------------------------------------- |
| `UI / App Shell`        | Screen selection, overlays, layout shell                  | `apps/desktop/src/App.tsx`, `apps/desktop/src/app/**`, `packages/ui/src/components/**` | `400`       | `500`    | Hooks, domain selectors/types, desktop contract             |
