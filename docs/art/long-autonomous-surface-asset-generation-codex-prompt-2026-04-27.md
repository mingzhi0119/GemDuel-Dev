...
- Keep overlays readable. Shell backgrounds may use theme-related landscapes,
  environmental wonders, architectural distance views, natural wonders, or
  premium material surfaces, but the result must remain a low-contrast,
  low-noise wide environment behind the gameplay UI. Do not put a strong central
  subject, character, monster, tower, large sun or moon disk, bright focal glow,
  localized stage, edge frame, or functional center-vs-edge composition split
  under the React-rendered gameplay zones. For TopBar, PlayerZone, gem panels,
  and card backs, avoid busy functional areas that sit under React-rendered UI.
