...
| `VL-SHELL-17-CANDIDATE-CLEAN-BOARDGAME-A`           | `candidate` | `clean-boardgame`           | `A`     | `assets/art-library/surface-autonomous-candidates/2026-04-29/shell-background/clean-boardgame/shell-background-a.png`                             | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-18-CANDIDATE-CLEAN-BOARDGAME-B`           | `candidate` | `clean-boardgame`           | `B`     | `assets/art-library/surface-autonomous-candidates/2026-04-29/shell-background/clean-boardgame/shell-background-b.png`                             | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-19-CANDIDATE-CRYSTAL-ANIME-A`             | `candidate` | `crystal-anime`             | `A`     | `assets/art-library/surface-autonomous-candidates/2026-04-29/shell-background/crystal-anime/shell-background-a.png`                               | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-20-CANDIDATE-CRYSTAL-ANIME-B`             | `candidate` | `crystal-anime`             | `B`     | `assets/art-library/surface-autonomous-candidates/2026-04-29/shell-background/crystal-anime/shell-background-b.png`                               | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-21-CANDIDATE-DARK-ARCANE-A`               | `candidate` | `dark-arcane`               | `A`     | `assets/art-library/surface-autonomous-candidates/2026-04-29/shell-background/dark-arcane/shell-background-a.png`                                 | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-22-CANDIDATE-DARK-ARCANE-B`               | `candidate` | `dark-arcane`               | `B`     | `assets/art-library/surface-autonomous-candidates/2026-04-29/shell-background/dark-arcane/shell-background-b.png`                                 | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-23-CANDIDATE-ROYAL-LUXURY-A`              | `candidate` | `royal-luxury`              | `A`     | `assets/art-library/surface-autonomous-candidates/2026-04-29/shell-background/royal-luxury/shell-background-a.png`                                | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-24-CANDIDATE-ROYAL-LUXURY-B`              | `candidate` | `royal-luxury`              | `B`     | `assets/art-library/surface-autonomous-candidates/2026-04-29/shell-background/royal-luxury/shell-background-b.png`                                | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-36-CANDIDATE-BAMBOO-INK-B`                | `candidate` | `bamboo-ink`                | `B`     | `assets/art-library/surface-autonomous-legendary-styles-candidates/2026-04-27/shell-background/bamboo-ink/shell-background-b.png`                 | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-38-CANDIDATE-LAPIS-SUNBURST-B`            | `candidate` | `lapis-sunburst`            | `B`     | `assets/art-library/surface-autonomous-legendary-styles-candidates/2026-04-27/shell-background/lapis-sunburst/shell-background-b.png`             | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-39-CANDIDATE-OPAL-RAIN-A`                 | `candidate` | `opal-rain`                 | `A`     | `assets/art-library/surface-autonomous-legendary-styles-candidates/2026-04-27/shell-background/opal-rain/shell-background-a.png`                  | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-41-CANDIDATE-VOLCANIC-ROSE-GOLD-A`        | `candidate` | `volcanic-rose-gold`        | `A`     | `assets/art-library/surface-autonomous-legendary-styles-candidates/2026-04-27/shell-background/volcanic-rose-gold/shell-background-a.png`         | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-42-CANDIDATE-VOLCANIC-ROSE-GOLD-B`        | `candidate` | `volcanic-rose-gold`        | `B`     | `assets/art-library/surface-autonomous-legendary-styles-candidates/2026-04-27/shell-background/volcanic-rose-gold/shell-background-b.png`         | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-52-CANDIDATE-ASTRAL-ORCHID-B`             | `candidate` | `astral-orchid`             | `B`     | `assets/art-library/surface-autonomous-mythic-styles-candidates/2026-04-27/shell-background/astral-orchid/B/shell-background.png`                 | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-53-CANDIDATE-AURORA-STEEL-A`              | `candidate` | `aurora-steel`              | `A`     | `assets/art-library/surface-autonomous-mythic-styles-candidates/2026-04-27/shell-background/aurora-steel/A/shell-background.png`                  | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-55-CANDIDATE-BASALT-AQUAMARINE-A`         | `candidate` | `basalt-aquamarine`         | `A`     | `assets/art-library/surface-autonomous-mythic-styles-candidates/2026-04-27/shell-background/basalt-aquamarine/A/shell-background.png`             | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-58-CANDIDATE-PORCELAIN-CINNABAR-B`        | `candidate` | `porcelain-cinnabar`        | `B`     | `assets/art-library/surface-autonomous-mythic-styles-candidates/2026-04-27/shell-background/porcelain-cinnabar/B/shell-background.png`            | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-71-CANDIDATE-EMBER-FORGE-A`               | `candidate` | `ember-forge`               | `A`     | `assets/art-library/surface-autonomous-new-themes-candidates/2026-04-29/shell-background/ember-forge/shell-background-a.png`                      | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-72-CANDIDATE-EMBER-FORGE-B`               | `candidate` | `ember-forge`               | `B`     | `assets/art-library/surface-autonomous-new-themes-candidates/2026-04-29/shell-background/ember-forge/shell-background-b.png`                      | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-75-CANDIDATE-CLOCKWORK-GARDEN-A`          | `candidate` | `clockwork-garden`          | `a`     | `assets/art-library/surface-autonomous-new-themes-r2-candidates/2026-04-29/shell-background/clockwork-garden/shell-background-a.png`              | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-76-CANDIDATE-CLOCKWORK-GARDEN-B`          | `candidate` | `clockwork-garden`          | `b`     | `assets/art-library/surface-autonomous-new-themes-r2-candidates/2026-04-29/shell-background/clockwork-garden/shell-background-b.png`              | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-78-CANDIDATE-STORM-TEMPLE-B`              | `candidate` | `storm-temple`              | `b`     | `assets/art-library/surface-autonomous-new-themes-r2-candidates/2026-04-29/shell-background/storm-temple/shell-background-b.png`                  | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-80-CANDIDATE-SUNKEN-OPAL-B`               | `candidate` | `sunken-opal`               | `b`     | `assets/art-library/surface-autonomous-new-themes-r2-candidates/2026-04-29/shell-background/sunken-opal/shell-background-b.png`                   | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-81-CANDIDATE-VELVET-NOIR-A`               | `candidate` | `velvet-noir`               | `a`     | `assets/art-library/surface-autonomous-new-themes-r2-candidates/2026-04-29/shell-background/velvet-noir/shell-background-a.png`                   | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-82-CANDIDATE-VELVET-NOIR-B`               | `candidate` | `velvet-noir`               | `b`     | `assets/art-library/surface-autonomous-new-themes-r2-candidates/2026-04-29/shell-background/velvet-noir/shell-background-b.png`                   | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-83-CANDIDATE-CELESTIAL-COPPER-A`          | `candidate` | `celestial-copper`          | `A`     | `assets/art-library/surface-autonomous-prismatic-styles-candidates/2026-04-27/shell-background/celestial-copper/shell-background-a.png`           | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-84-CANDIDATE-CELESTIAL-COPPER-B`          | `candidate` | `celestial-copper`          | `B`     | `assets/art-library/surface-autonomous-prismatic-styles-candidates/2026-04-27/shell-background/celestial-copper/shell-background-b.png`           | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-85-CANDIDATE-FROSTED-AMBERGLASS-A`        | `candidate` | `frosted-amberglass`        | `A`     | `assets/art-library/surface-autonomous-prismatic-styles-candidates/2026-04-27/shell-background/frosted-amberglass/shell-background-a.png`         | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-86-CANDIDATE-FROSTED-AMBERGLASS-B`        | `candidate` | `frosted-amberglass`        | `B`     | `assets/art-library/surface-autonomous-prismatic-styles-candidates/2026-04-27/shell-background/frosted-amberglass/shell-background-b.png`         | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-87-CANDIDATE-MOSS-AGATE-A`                | `candidate` | `moss-agate`                | `A`     | `assets/art-library/surface-autonomous-prismatic-styles-candidates/2026-04-27/shell-background/moss-agate/shell-background-a.png`                 | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-88-CANDIDATE-MOSS-AGATE-B`                | `candidate` | `moss-agate`                | `B`     | `assets/art-library/surface-autonomous-prismatic-styles-candidates/2026-04-27/shell-background/moss-agate/shell-background-b.png`                 | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-90-CANDIDATE-NOCTURNE-PEARL-B`            | `candidate` | `nocturne-pearl`            | `B`     | `assets/art-library/surface-autonomous-prismatic-styles-candidates/2026-04-27/shell-background/nocturne-pearl/shell-background-b.png`             | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-94-CANDIDATE-GLACIER-SILVER-B`            | `candidate` | `glacier-silver`            | `B`     | `assets/art-library/surface-autonomous-ultra-styles-candidates/2026-04-27/shell-background/glacier-silver/B/shell-background.png`                 | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-95-CANDIDATE-IVORY-VERDIGRIS-A`           | `candidate` | `ivory-verdigris`           | `A`     | `assets/art-library/surface-autonomous-ultra-styles-candidates/2026-04-27/shell-background/ivory-verdigris/A/shell-background.png`                | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
| `VL-SHELL-96-CANDIDATE-IVORY-VERDIGRIS-B`           | `candidate` | `ivory-verdigris`           | `B`     | `assets/art-library/surface-autonomous-ultra-styles-candidates/2026-04-27/shell-background/ivory-verdigris/B/shell-background.png`                | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
...
| `VL-SHELL-98-CANDIDATE-MIDNIGHT-NAVIGATOR-B`        | `candidate` | `midnight-navigator`        | `B`     | `assets/art-library/surface-autonomous-ultra-styles-candidates/2026-04-27/shell-background/midnight-navigator/B/shell-background.png`             | `3840x2160` |     8 | Watch for subtle accidental center emphasis in final human pass. |
