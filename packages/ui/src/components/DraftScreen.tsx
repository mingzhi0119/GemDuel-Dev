...
export const DraftScreen: React.FC<DraftScreenProps> = ({
    ...
    return (
        <div
            className={`relative h-full w-full flex flex-col items-center justify-center overflow-hidden transition-colors duration-500
        ...
        >
            ...
            <div className="z-10 flex flex-col items-center lg:scale-[1.5] lg:transform-gpu lg:origin-center">
                ...
                <div
                    className={`mb-8 flex items-center gap-3 px-6 py-3 rounded-full border shadow-lg
                    ${
                        activePlayer === 'p1'
