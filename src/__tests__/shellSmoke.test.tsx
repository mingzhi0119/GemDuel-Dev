...
import type { AppRouteProps, ResponsiveLayout } from '../types';
import { createMockState } from '../logic/__tests__/testHelpers';

vi.mock('../components/GameActions', () => ({
